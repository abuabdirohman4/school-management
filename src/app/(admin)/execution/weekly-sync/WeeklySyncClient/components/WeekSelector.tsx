  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="w-full md:relative">
        <button
          className="lex items-center justify-center gap-1 px-4 py-2 rounded-lg border border-gray-400 bg-white dark:text-white dark:bg-gray-900 cursor-pointer w-full md:min-w-24 dropdown-toggle hover:bg-gray-50 dark:hover:bg-gray-800"
